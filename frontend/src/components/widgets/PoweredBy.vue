<template lang='pug'>
  .powered-by
    ...
    el-row(v-else).powered-by-logos
      el-col.powered-by-logo(:xs="24", :sm="12", :md="12", :lg="12" v-for='item in softwareInfos' v-bind:key="item.text")
        a(:href='item.href')
...
<script>
var allSoftwareInfos = {
  bandwagon: {
    name: 'BandWagon',
    logoSrc: '/static/logos/bandwagon.png',
  ...
  dnacauldron: {
    ...
    href: 'https://github.com/Edinburgh-Genome-Foundry/DnaCauldron'
  },
  dnachisel: {
    name: 'DNA Chisel',
